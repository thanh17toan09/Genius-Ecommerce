...
EOD;
      ...
      <?php
      $sql_arrs_list = "SELECT * FROM `thongtin_sanpham` WHERE NhanHieu = 1";
      ...
      <?php
        ...
        $start=($page-1)*$limit;
        $sql_arrs = "SELECT * FROM `thongtin_sanpham` WHERE NhanHieu = 1  LIMIT $start,$limit";
...
EOD;
     ...
     <?php if($total_page > 1){ ?>
      <nav class="d-flex justify-content-center wow fadeIn" style="margin-top: 100px">
          ...
          <!--Arrow left-->
          <li class="page-item">
            <a class="page-link" href="iPhone_Page.php?page=<?php echo 1; ?>" aria-label="Previous">
              <span aria-hidden="true">&laquo;</span>
              <span class="sr-only">Previous</span>
            </a>
					<?php for($i=1;$i<=$total_page;$i++){ ?>
				    <li <?php if($page == $i) echo "class='page-item active'"; ?> >
              <a class="page-link" href="iPhone_Page.php?page=<?php echo $i; ?>"><?php echo $i; ?>
              </a>
          </li><?php }?>
          <li class="page-item">
            <a class="page-link" href="iPhone_Page.php?page=<?php echo $total_page; ?>" aria-label="Next">
